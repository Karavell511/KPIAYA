...
class KPIInstance(Base):
    ...
    salary_share_percent: Mapped[float] = mapped_column(Numeric(6, 2), default=0)
    overtime_hours_x1: Mapped[float] = mapped_column(Numeric(8, 2), default=0)
    overtime_hours_x2: Mapped[float] = mapped_column(Numeric(8, 2), default=0)
